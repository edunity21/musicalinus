...
const ERR_TEXT = {
  ...
  ENTRY_CLOSED:      '들어올 수 없는 상태입니다. 선생님께 알려 주세요.',
  GROUP_FULL:        '그 모둠은 다섯 명이 다 찼습니다. 다른 모둠을 골라 주세요.',
  ALL_FULL:          '여섯 모둠이 모두 찼습니다. 선생님께 말씀해 주세요.',
  JOB_TEACHER_ONLY:  '그 자리는 선생님이 넣어 주는 자리입니다.',
  JOB_TAKEN:         '그 제작 역할은 이미 다른 학생이 맡았습니다.',
  ROLE_TAKEN:        '그 배역은 이미 다른 학생이 맡았습니다.',
  BUSY:              '지금 여러 명이 한꺼번에 자리를 잡고 있습니다. 잠시 뒤 다시 눌러 주세요.',
  ...
  ALREADY_SUBMITTED: '이미 냈습니다. 고쳐서 다시 내려면 새로고침한 뒤 다시 해 보세요.',
