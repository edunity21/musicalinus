...
const COMMON_VERSION = 'common v1.3.0 (2026-09-07) 오류문구추가';
...
const ERR_TEXT = {
  ...
  SEAT_NOT_OPEN:     '여섯 번째 자리는 다섯 자리가 다 찬 뒤에 열립니다.',
  NOT_LEADER:        '제출은 발표 리더만 할 수 있습니다.',
  TOO_BIG:           '파일이 너무 큽니다. 동영상은 [영상 내기]로 내세요.',
  BAD_TYPE:          '올릴 수 없는 종류의 파일입니다.',
  TOO_MANY:          '올린 파일이 너무 많습니다.',
  DRIVE_FAIL:        '드라이브에 넣지 못했습니다. 선생님께 알려 주세요.',
  NOT_OWNER:         '올린 사람이나 발표 리더만 지울 수 있습니다.',
  NO_GROUP:          '아직 모둠에 들어가지 않았습니다.',
